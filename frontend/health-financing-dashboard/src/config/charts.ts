    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 75.5 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 56.1 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 72.0 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 60.0 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "met", percentBelow: 0 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "moderate", percentBelow: 38.7 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 135.0 },
    ...
    enhancedAnalytics: {
      ...
      geographicPatterns: {
        ...
        targetAchievementMap: {
          ...
          "Cote d'Ivoire": { status: "far", percentBelow: 412.8 },
